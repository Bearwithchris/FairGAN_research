...
train_dir1 = 'D:/GIT/local_data_in_use/Train/Male'
train_dir2 = 'D:/GIT/local_data_in_use/Train/female'
# images_concat_shuffled,images_labels_concat_shuffled=data.prep_dataset(train_dir1,train_dir2)

images_labels_concat_shuffled,images_concat_shuffled=data.datasets(dim,train_dir1,train_dir2,13000,bias=0.9)
...
model=resnet18.make_resnet_18(dim).call()
